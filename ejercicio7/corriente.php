    ...
    <table class="table">
      ...
      <tbody>
        <?php 
            ...
            $result = mysqli_query($conexion,"SELECT * FROM  cuenta as A INNER JOIN persona as B ON (B.idPersona=A.idPersona and B.nombre='$usuario' and A.tipoCuenta='Corriente')");
