  ...
  <header >
    ...
    <nav class="navbar navbar-expand navbar-light bg-light">
        <div class="nav navbar-nav">
            ...
            <a class="nav-item nav-link" href="<?php echo $url_base;?>ejercicio7/cuentasC.php">Cuentas</a>
            <a class="nav-item nav-link" href="<?php echo $url_base;?>ejercicio7/corriente.php">Cuentas Corrientes</a>
            <a class="nav-item nav-link" href="<?php echo $url_base;?>ejercicio7/ahorro.php">Cuentas de Ahorro</a>
            <a class="nav-item nav-link" href="<?php echo $url_base;?>ejercicio7/plazofijo.php">Cuentas de Plazo Fijo</a>
